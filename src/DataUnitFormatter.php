 ...
 */
final readonly class Data_Unit_Formatter implements Filter_Interface
{
    ...
    public function filter(mixed $value): mixed
    {
        ...
        return $this->format_amount($formatted, $prefix);
    }
    private function format_amount(string|float $amount, ?string $prefix = null): string
    {
